...
const links = [
    { href: '/properties-list?property-type=buy', text: 'Villas' },
    { href: '/properties-list?property-type=rent', text: 'Houses' },
    { href: '/properties-list?property-type=new', text: 'Appartments' },
    { href: '/properties-list?property-type=commercial', text: 'Commercial' },
    { href: '/properties-list?property-type=commercial', text: 'Land' },
                    ...
                    <nav className="custom-navbar navbar navbar-expand-lg">
                        ...
                        <div className="d-flex gap-1 ms-lg-5">
                            ...
                            {userType ?
                                ...
                                :
                                <>
                                    <Link href="signin" className="btn btn-primary btn-login hstack gap-2" style={{ backgroundColor: '#fdbd61' }}>
                                        <i className="fa-solid fa-arrow-right-to-bracket" style={{color: '#0a73c0'}}></i>
                                        <div className="vr d-none d-sm-inline-block" ></div>
                                        <span className="d-none d-sm-inline-block" style={{color: '#0a73c0'}}>Publish Your Listing</span>
                                    </Link>
